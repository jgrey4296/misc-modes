...
(defcustom org-epub-htmlize-output-type 'css
...
(defcustom org-epub-footnotes-section "<div id=\"footnotes\">
...
(defcustom org-epub-format-headline-function
  'org-epub-format-headline-default-function
...
(defcustom org-epub-inline-image-rules
...
(defvar org-epub-standalone-image-predicate)
;;-- end images

;;-- html file settings

(defcustom org-epub-xml-declaration
...
(defcustom org-epub-postamble-format
...
postamble itself.  This format string can contain these elements:
  ...
  %c will be replaced by `org-epub-creator-string'.
  %v will be replaced by `org-epub-validation-link'.
...
(defcustom org-epub-home/up-format
  ""
