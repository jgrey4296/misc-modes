...
;;;###autoload
(define-minor-mode browse-select-mode
  "An interface for controlling what browser is used for opening http links"
  :global t
  :lighter (:eval (format "Browser: %s" browse-select-default-prog))
)
